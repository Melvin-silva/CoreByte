...
urlpatterns = [
    ...
    path('cupons/novo/', views.cupom_criar, name='cupom_criar'),
    path('cupons/<int:cupom_id>/editar/', views.cupom_editar, name='cupom_editar'),
    path('cupons/<int:cupom_id>/excluir/', views.cupom_excluir, name='cupom_excluir'),
    path('carrinho/', views.carrinho_view, name='carrinho'),
    path('checkout/', views.checkout_view, name='checkout'),
    path('checkout/validar-cupom/', views.validar_cupom_checkout, name='validar_cupom_checkout'),
